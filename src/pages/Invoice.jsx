          ...
          <div className="flex flex-col justify-center sm:items-start lg:items-center sm:my-10 lg:-my-10 xl:my-60">
            ...
            <button className="btn bg-gray-300 text-gray-400 rounded-lg w-48 h-11 mb-10">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <mask id="path-1-inside-1_843_2484" fill="white">
                ...
                <path
                  ...
                  fill="#999999"
                  fill-opacity="0.5"
                  mask="url(#path-1-inside-1_843_2484)"
                />
                <path
                  d="M17.34 2.64167C16.67 1.97084 15.5009 1.97084 14.83 2.64167L8.87754 8.59417C8.82087 8.65084 8.78004 8.72251 8.76087 8.80001L8.13421 11.3092C8.09671 11.46 8.14087 11.62 8.25087 11.7308C8.33504 11.815 8.44837 11.8608 8.56421 11.8608C8.60004 11.8608 8.63587 11.8567 8.67171 11.8475L11.1817 11.22C11.26 11.2008 11.3309 11.16 11.3875 11.1033L17.34 5.15084C17.675 4.81584 17.86 4.37001 17.86 3.89584C17.86 3.42167 17.6759 2.97667 17.34 2.64167ZM10.8475 10.3892L9.17421 10.8075L9.59254 9.13418L14.5167 4.21001L15.7717 5.46501L10.8475 10.3892ZM16.7125 4.52334L16.3992 4.83667L15.1442 3.58167L15.4575 3.26834C15.7925 2.93334 16.3775 2.93334 16.7125 3.26834C16.88 3.43584 16.9725 3.65834 16.9725 3.89584C16.9725 4.13334 16.88 4.35584 16.7125 4.52334Z"
                  fill="#999999"
                  fill-opacity="0.5"
                />
              </svg>

              <span className=" ml-2 mr-2">Edit Invoice</span>
            </button>
            <button className="btn invoice-btn w-48 h-11 mb-10 rounded-lg text-white">
              ...
              >
                <path
                  d="M9.38428 16.5746C9.27443 16.5745 9.16681 16.5436 9.07371 16.4853C8.9806 16.427 8.90576 16.3437 8.85772 16.2449L6.10381 10.5836L0.442485 7.83008C0.340501 7.78037 0.255142 7.70212 0.196773 7.60483C0.138404 7.50754 0.109534 7.3954 0.113671 7.28202C0.117807 7.16864 0.154771 7.0589 0.220075 6.96613C0.285378 6.87335 0.376212 6.80153 0.481547 6.75938L15.0093 0.91602C15.1159 0.873053 15.2328 0.862386 15.3454 0.885347C15.458 0.908307 15.5614 0.963882 15.6426 1.04515C15.7239 1.12642 15.7795 1.2298 15.8025 1.34242C15.8254 1.45504 15.8147 1.57192 15.7718 1.67852L9.92803 16.2074C9.88566 16.3127 9.81365 16.4034 9.72073 16.4685C9.62781 16.5336 9.51799 16.5703 9.40459 16.5742L9.38428 16.5746ZM2.14288 7.35586L6.79834 9.62149C6.91634 9.67887 7.01167 9.77419 7.06905 9.89219L9.33467 14.5477L14.1702 2.51446L2.14288 7.35586Z"
                  fill="white"
                />
                <path
                  d="M6.54284 10.731C6.42695 10.731 6.31367 10.6966 6.21732 10.6322C6.12098 10.5678 6.0459 10.4762 6.00157 10.3692C5.95725 10.2621 5.94568 10.1442 5.96832 10.0306C5.99097 9.91693 6.04681 9.81254 6.12878 9.73062L14.8143 1.04507C14.8688 0.990668 14.9334 0.94752 15.0045 0.918088C15.0756 0.888656 15.1518 0.873517 15.2287 0.873535C15.3057 0.873553 15.3819 0.888728 15.453 0.918194C15.5241 0.947659 15.5886 0.990838 15.643 1.04526C15.6974 1.09969 15.7406 1.1643 15.77 1.2354C15.7995 1.3065 15.8146 1.38271 15.8146 1.45966C15.8146 1.53661 15.7994 1.61281 15.7699 1.6839C15.7405 1.75499 15.6973 1.81957 15.6428 1.87398L6.9573 10.5611C6.8471 10.6704 6.69805 10.7315 6.54284 10.731Z"
                  fill="white"
                />
              </svg>
