  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        // className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:tranorange-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-red-800 p-4 transition-all duration-200 ease-in-out ${
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:tranorange-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-white shadow-lg p-4 transition-all duration-200 ease-in-out ${
          sidebarOpen ? "tranorange-x-0" : "-tranorange-x-64"
        }`}
      >
        {/* Sidebar header */}
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <button
            ref={trigger}
            className="lg:hidden text-orange-500 hover:text-orange-400"
              ...
              >
                <NavLink
                  ...
                  className={`block text-gray-500 hover:text-orange-600 truncate transition duration-150 ${
                    pathname.includes("package-tracking") &&
                    "hover:text-gray-200"
                  }`}
                >
          ...
          <div className="px-3 py-2">
            <button onClick={() => setSidebarExpanded(!sidebarExpanded)}>
              ...
              >
                ...
                />
                <path className="text-orange-600" d="M3 23H1V1h2z" />
              </svg>
            </button>
          </div>
        </div>
