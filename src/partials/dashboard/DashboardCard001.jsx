  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          ...
          <EditMenu className="relative inline-flex">
            ...
            <li>
              <Link
                className="font-medium text-sm text-orange-500 hover:text-orange-600 flex py-1 px-3"
                to="#0"
              >
                Remove
              </Link>
        ...
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 mr-2">50</div>
      ...
      <div className="grow">
        ...
        <LineChart data={chartData} width={389} height={98} />
      </div>
    </div>
  );
}
